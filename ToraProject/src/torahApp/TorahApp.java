 ...
 *
 */
public class TorahApp {
	// static StringBuffer buffer = new StringBuffer();
	// static Formatter formatter = new Formatter(buffer, new Locale("he", "IL"));

	public static String resourceFolder = "";
	public static final String TorahLineFile = resourceFolder + "Lines.txt";
	public static final String TorahLetterFile = resourceFolder + "NoTevot.txt";
	public static final String TorahTables = resourceFolder + "TorahTables.xls";
	...
	public static void starter() throws IOException {
		...
		tablePerekBooks = ExcelFunctions.readBookTableXLS(
				new String[] { TorahTables, PropStore.map.get(PropStore.subTorahTablesFile) }, 0, 0, 1, 6, 53);
		pereksPerBook = getPereksPerBook(tablePerekBooks);
		tablePerekParashot = ExcelFunctions.readBookTableXLS(
				new String[] { TorahTables, PropStore.map.get(PropStore.subTorahTablesFile) }, 1, 0, 1, 2, 56);
	}

	public static Boolean isGui() {
		return (TorahApp.guiMode == id_guiMode_Frame);
	}
	...
	public static LineReport returnBookInfoExtraIndexes(String searchStringTitle, int countLines, LineHtmlReport lineHtmlReport, ArrayList<Integer[]> addIndexes) {
		...
		try {
			...
			String tempStr2 = StringAlignUtils.padRight(tempStr1, 32) + " =    "
					+ lineHtmlReport.getLineHtml(TorahApp.isGui());
