...
public class ToraApp {
	...
	public static void starter() throws IOException{
	    ...
	    //There are identical calls like this, one here the another in frame.PopupTextMenu())
		tablePerekBooks = ExcelFunctions.readXLS(new String[] {ToraTables,PropStore.map.get(PropStore.subTorahTablesFile)}, 0, 0, 1, 6, 53);
	}
